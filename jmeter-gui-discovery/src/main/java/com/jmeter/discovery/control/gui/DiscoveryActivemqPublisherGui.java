package com.jmeter.discovery.control.gui;
...
import com.jmeter.discovery.sampler.DiscoveryPublisherSampler;

public class DiscoveryActivemqPublisherGui extends AbstractSamplerGui implements ChangeListener {
    ...
    private static JLabeledTextField  zookeeperUrl = new JLabeledTextField(JMeterUtils.getResString("zookeeper_url")); 
    private static JLabeledTextField  zookeeperUser = new JLabeledTextField(JMeterUtils.getResString("zookeeper_user")); 
    private static JLabeledTextField  zookeeperPassword = new JLabeledTextField(JMeterUtils.getResString("zookeeper_password")); 
    ...
    public DiscoveryActivemqPublisherGui() {
        init();
    }

    /**
     * the name of the property for the DiscoveryActivemqPublisherGui is jms_publisher.
     */
    @Override
    public String getLabelResource() {
        return "jms_discovery_publisher"; //$NON-NLS-1$
    }
    ...
    public TestElement createTestElement() {
      DiscoveryPublisherSampler sampler = new DiscoveryPublisherSampler();
    ...
    public void modifyTestElement(TestElement s) {
    	DiscoveryPublisherSampler sampler = (DiscoveryPublisherSampler) s;
        setupSamplerProperties(sampler);
     ...
     */
    private void setupSamplerProperties(final DiscoveryPublisherSampler sampler) {
      ...
      sampler.setZookeeperPassword(zookeeperPassword.getText());
      sampler.setZookeeperUrl(zookeeperUrl.getText());
      sampler.setZookeeperUser(zookeeperUser.getText());
    ...
    private void init() {
        ...
        mainPanel.add(zookeeperUrl);
        mainPanel.add(zookeeperUser);
        mainPanel.add(zookeeperPassword);
    ...
    public void clearGui(){
        super.clearGui();
        zookeeperPassword.setText("");
        zookeeperUrl.setText("");
        zookeeperUser.setText("");
    ...
    public void configure(TestElement el) {
        super.configure(el);
        DiscoveryPublisherSampler sampler = (DiscoveryPublisherSampler) el;
        ...
        zookeeperUrl.setText(sampler.getZookeeperUrl());
        zookeeperPassword.setText(sampler.getZookeeperPassword());
